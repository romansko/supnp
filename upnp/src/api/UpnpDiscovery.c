...
{
    return p->m_AdvSignature;
}

int UpnpDiscovery_set_AdvSignature(UpnpDiscovery *p, const UpnpString *s)
{
    const char *q = UpnpString_get_String(s);

    return UpnpString_set_String(p->m_AdvSignature, q);
}

size_t UpnpDiscovery_get_AdvSignature_Length(const UpnpDiscovery *p)
{
    return UpnpString_get_Length(UpnpDiscovery_get_AdvSignature(p));
}

const char *UpnpDiscovery_get_AdvSignature_cstr(const UpnpDiscovery *p)
{
    return UpnpString_get_String(UpnpDiscovery_get_AdvSignature(p));
}

int UpnpDiscovery_strcpy_AdvSignature(UpnpDiscovery *p, const char *s)
{
    return UpnpString_set_String(p->m_AdvSignature, s);
}

int UpnpDiscovery_strncpy_AdvSignature(
    UpnpDiscovery *p, const char *s, size_t n)
{
    return UpnpString_set_StringN(p->m_AdvSignature, s, n);
}

void UpnpDiscovery_clear_AdvSignature(UpnpDiscovery *p)
{
    UpnpString_clear(p->m_AdvSignature);
}
